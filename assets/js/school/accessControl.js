                ...
                laypage({
                    ...
                    jump: function(obj, first) {
                        ...
                        if (data.countAllRS != 0) {
                            myAjax(data01, changeUrl.address + "/School_api?whereFrom=search", accessControl02)
                        } else {
                            $('#loadgif').hide()
                            $('#floatLayer').hide() //遮罩层
                        }
...
function accessData(fn) {
    ...
    if (jQuery.isEmptyObject(args)) {
        ...
        myAjax(data02, changeUrl.address + '/School_api?whereFrom=search', fn)
        ...
        $('#innerWrap').html('')
        myAjax(data01, changeUrl.address + '/School_api?whereFrom=search', fn)
