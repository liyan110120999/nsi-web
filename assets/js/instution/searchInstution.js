...
function createMsg(msg) {
    ...
    for (var i = 0; i < msg.length; i++) {
        ...
        var imgSrc = msg[i].Institution_logo ? (msg[i].Institution_logo != 0 ? +changeUrl.imgAddress + msg[i].Institution_logo : '../assets/img/schoolNoPic.png') : '../assets/img/schoolNoPic.png';
        $('#innerWrap').append(
